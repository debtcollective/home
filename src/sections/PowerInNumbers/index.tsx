...
const PowerInNumbers = () => {
  ...
  return (
    <BackgroundImage
      ...
      className="min-h-fish-section from-primary via-primary bg-gradient-to-r px-x-screen-spacing py-y-screen-spacing lg:p-desktop-screen-spacing flex items-center"
    >
