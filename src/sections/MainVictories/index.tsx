...
const MainVictories: React.FC = () => {
  ...
  return (
    <BackgroundImage
      fluid={coverImage}
      className="h-section-size max-h-section-max-size flex flex-col justify-center bg-no-repeat bg-cover bg-center px-x-screen-spacing py-y-screen-spacing lg:p-desktop-screen-spacing"
    >
